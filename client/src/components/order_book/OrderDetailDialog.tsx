...
const OrderDetailDialog = ({ open, order, onClose }: OrderDetailDialogProps) => {
  ...
  const isDelivered = order.delivery_flag === "Delivery Done";
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ p: 3 }}>
        ...
        >
          ...
          <CardContent>
            ...
            <InfoRow
              icon={<Flag />}
              label="Refill Type"
              value={order.refill_type}
            />
            {!isDelivered && order.payment_info && (
              <>
                <Divider />
                <InfoRow
                  icon={<Payment />}
        ...
        {/* Delivery Information - Only show if delivered */}
        {isDelivered && (
          <Card
            elevation={0}
            sx={{
        ...
        {/* Payment Information - Only show if delivered */}
        {isDelivered && order.payment_info && (
          <Card 
            elevation={0}
            sx={{ 
