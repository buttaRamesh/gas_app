...
class RouteConsumersPagination(PageNumberPagination):
    """
    Custom pagination for route consumers endpoint.
    Includes route info at root level along with paginated consumers.
    """
    page_size = 20
