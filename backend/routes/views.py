...
class RouteViewSet(viewsets.ModelViewSet):
    ...
    def consumers(self, request, pk=None):
        ...
        assignments = route.consumer_assignments.select_related(
            'consumer__person',
            'consumer__category'
        ).prefetch_related(
        ...
        for assignment in assignments:
            ...
            consumers_data.append({
                ...
                'address': consumer.person.addresses.first().address_text if consumer.person and consumer.person.addresses.exists() else None,
