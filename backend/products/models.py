...
from core.validators import validate_price, validate_quantity
...
class ProductVariant(models.Model):
    ...
    quantity = models.DecimalField(
        ...
        max_digits=10,
        decimal_places=2,
        validators=[MinValueValidator(Decimal('0.01'), message="Size must be greater than zero")],
...
class ProductVariantPriceHistory(models.Model):
    ...
    new_price = models.DecimalField(
        ...
        max_digits=10,
        decimal_places=2,
        validators=[MinValueValidator(Decimal('0.01'), message="New price must be greater than zero")],
